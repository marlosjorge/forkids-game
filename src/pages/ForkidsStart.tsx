...
export default function ForkidsStart() {
    ...
    return (
        ...
        <View style={styles.buttons}>
            <Text style={styles.textButtons}> <Feather name="check-square" size={30} color="#000" /> Inglês</Text>
            <Text style={styles.textButtons}> <Feather name="check-square" size={30} color="#000" /> Português</Text>
